...
sublis = rddlis.map(lambda x: x-2)
print()
print("================sublis================")
print(sublis.collect())

mutlis = rddlis.map (lambda x: x*2)
print()
print("============mutlis=============")
print(mutlis.collect())

Divlis = rddlis.map(lambda x: x /2)
print()
print("=========Divlis==========")
print(Divlis.collect())
